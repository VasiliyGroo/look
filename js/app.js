...
function getIdFilm2(id2) {
  ...
  let pers;
   async function getPersonaMovies() {
     ...
     actor.innerHTML = `В ролях: ${actors[1] || `Неизвестно`}, ${actors[2] || `Неизвестно`}, ${actors[3] || `Неизвестно`}, ${actors[4] || `Неизвестно`}, ${actors[5] || `Неизвестно`}, ${actors[6] || `Неизвестно`}, ${actors[7] || `Неизвестно`}, ${actors[8] || `Неизвестно`}...`;
   }
   getPersonaMovies();
 }
